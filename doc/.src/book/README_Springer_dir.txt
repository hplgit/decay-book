...
(note that svmono.cls is modified to svmonodo.cls, and t4do.sty is
an adaption of the t2.sty file for the T2 format to the T4 format).

The tarball with all the files for the book, as well as book.tex as
a separate file, is always available from the directory

https://www.dropbox.com/sh/wsjnwv6gq88844u/AAAvs3bvJwKuzMde9cUvBviBa?dl=0
