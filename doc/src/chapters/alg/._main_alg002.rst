...
The :math:`L^2` norm :ref:`(47) <Eq:decay:norms:L2>` ("L-two norm")
...
norm :ref:`(51) <Eq:decay:norms:l2>` or the max norm :math:`\ell^\infty`
:ref:`(53) <Eq:decay:norms:linf>`, but the corresponding vector norms
:ref:`(54) <Eq:decay:norms:vl2>`-:ref:`(56) <Eq:decay:norms:vlinf>` are also much used
