# -*- coding: utf-8 -*-
#
# Algorithms and implementations for exponential decay models documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 10 01:28:21 2015.
#
...
project = u'Algorithms and implementations for exponential decay models'
short_title = project
...
htmlhelp_basename = 'Algorithmsandimplementationsforexponentialdecaymodelsdoc'
...
latex_documents = [
  (master_doc, 'Algorithmsandimplementationsforexponentialdecaymodels.tex', u'Algorithms and implementations for exponential decay models Documentation',
...
man_pages = [
    (master_doc, 'algorithmsandimplementationsforexponentialdecaymodels', u'Algorithms and implementations for exponential decay models Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Algorithmsandimplementationsforexponentialdecaymodels', u'Algorithms and implementations for exponential decay models Documentation',
   author, 'Algorithmsandimplementationsforexponentialdecaymodels', 'One line description of project.',
   'Miscellaneous'),
]
