# -*- coding: utf-8 -*-
#
# Analysis of exponential decay models documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 10 01:29:22 2015.
#
...
project = u'Analysis of exponential decay models'
short_title = project
...
htmlhelp_basename = 'Analysisofexponentialdecaymodelsdoc'
...
latex_documents = [
  (master_doc, 'Analysisofexponentialdecaymodels.tex', u'Analysis of exponential decay models Documentation',
...
man_pages = [
    (master_doc, 'analysisofexponentialdecaymodels', u'Analysis of exponential decay models Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Analysisofexponentialdecaymodels', u'Analysis of exponential decay models Documentation',
   author, 'Analysisofexponentialdecaymodels', 'One line description of project.',
   'Miscellaneous'),
]
