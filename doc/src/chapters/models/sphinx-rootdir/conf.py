# -*- coding: utf-8 -*-
#
# Generalizations of exponential decay models documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 10 01:33:40 2015.
#
...
project = u'Generalizations of exponential decay models'
short_title = project
...
htmlhelp_basename = 'Generalizationsofexponentialdecaymodelsdoc'
...
latex_documents = [
  (master_doc, 'Generalizationsofexponentialdecaymodels.tex', u'Generalizations of exponential decay models Documentation',
...
man_pages = [
    (master_doc, 'generalizationsofexponentialdecaymodels', u'Generalizations of exponential decay models Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Generalizationsofexponentialdecaymodels', u'Generalizations of exponential decay models Documentation',
   author, 'Generalizationsofexponentialdecaymodels', 'One line description of project.',
   'Miscellaneous'),
]
