# -*- coding: utf-8 -*-
#
# Software engineering with exponential decay models documentation build configuration file, created by
# sphinx-quickstart on Sat Oct 10 01:34:49 2015.
#
...
project = u'Software engineering with exponential decay models'
short_title = project
...
htmlhelp_basename = 'Softwareengineeringwithexponentialdecaymodelsdoc'
...
latex_documents = [
  (master_doc, 'Softwareengineeringwithexponentialdecaymodels.tex', u'Software engineering with exponential decay models Documentation',
...
man_pages = [
    (master_doc, 'softwareengineeringwithexponentialdecaymodels', u'Software engineering with exponential decay models Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Softwareengineeringwithexponentialdecaymodels', u'Software engineering with exponential decay models Documentation',
   author, 'Softwareengineeringwithexponentialdecaymodels', 'One line description of project.',
   'Miscellaneous'),
]
